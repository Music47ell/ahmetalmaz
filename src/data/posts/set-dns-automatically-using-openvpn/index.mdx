...
[^fn1]: I've been using TorGuard for 2 years now without any issues.

[^fn2]: [iOS](https://itunes.apple.com/us/app/openvpn-connect/id590379981) and [Android](https://play.google.com/store/apps/details?id=net.openvpn.openvpn&hl=en)
