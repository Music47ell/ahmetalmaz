...
published_at: 2023-08-03T11:13:24+03:00
cover:
  src: ./_assets/maestral.png
  alt: Maestral Review - How to Ignore node_modules in Dropbox with Maestral
tags: ['Reviews', 'Encrypted Cloud Storage']
---
...
> Info: ICYMI, I recently wrote two articles about how to exclude node_modules from syncing during backup. The first one uses [rsync](/sync-node-project-ignore-node-modules-rsync-bash-script) and the second one uses [Filen](/filen-review-dropbox-alternative-exclude-node-modules-sync)
