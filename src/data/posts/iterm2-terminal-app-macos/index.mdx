...
The first time I started using a terminal app was back in the days when this site was hosted on Digital Ocean. I used to SSH into my server when I needed to manage the backend of my site.

Now, I use the terminal to build and manage this site on GitHub.
...
![iterm2_hotkey](./_assets/iterm2_hotkey.png)
...
![iterm2_split_panes](./_assets/iterm2_split_panes.png)
...
![iterm2_imgcat_imgls_preview](./_assets/iterm2_imgcat_imgls_preview.png)
...
![iTerm2_experimental_settings](./_assets/iterm2_experimental_settings.png)
