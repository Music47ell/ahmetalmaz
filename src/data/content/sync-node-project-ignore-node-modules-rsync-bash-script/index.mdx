...
> Info: ICYMI, I recently wrote two articles about how to exclude node_modules from syncing during backup. The first one uses [Maestral](/maestral-review-exclude-node-modules-dropbox-mignore-gitignore) and the second one uses [Filen](/maestral-review-exclude-node-modules-dropbox-mignore-gitignore)
