...
Just like with my [Arch review](https://ahmetalmaz.com/how-to/install-arch-linux-guide/), Fish wasn't my first option. Before I tried it, I-like many I'm assuming-installed Zsh and [Oh My Zsh](https://ohmyz.sh/) and I used it for a while in conjunction with [Powerlevel9k](https://github.com/bhilburn/powerlevel9k).
