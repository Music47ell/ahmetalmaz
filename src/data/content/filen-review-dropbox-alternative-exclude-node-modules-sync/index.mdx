---
type: post
title: Filen Review - Dropbox alternative with node_modules folder exclusion
...
tags: ['Encrypted Cloud Storage', 'E2EE']
---
...
> Info: ICYMI, I recently wrote two articles about how to exclude node_modules from syncing during backup. The first one uses [rsync](/sync-node-project-ignore-node-modules-rsync-bash-script) and the second one uses [Maestral](/maestral-review-exclude-node-modules-dropbox-mignore-gitignore)
